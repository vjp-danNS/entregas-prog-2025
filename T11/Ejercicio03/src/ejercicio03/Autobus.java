...
public class Autobus {
    ...
    public static void aparcar(Autobus[] aparcamiento){
        ...
        //Variables
        String matricula;//Variable para guardar matricula al crear el objeto Autobus
        ...
        boolean checker=false;//Comprueba que no se pongan opciones fuera del rango permitido
        ...
        do {            
            ...
            checker=false;
            do {
                System.out.println("Deseas guardar mas conductores Y/N: ");
