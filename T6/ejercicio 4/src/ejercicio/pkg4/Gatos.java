...
public class Gatos extends Felinos {
    ...
    public Gatos(String sound, String alimentacion, String habitat, String cientName, String nombre, int edad, int peso) {
    ...
    public String toString() {
        return "Gatos{ nombre=" + getNombre()+ ", edad=" + getEdad() + ", peso=" + getPeso()+ ", sound=" + sound + ", alimentacion=" + alimentacion + ", habitat=" + habitat + ", cientName=" + cientName + '}';
    }
