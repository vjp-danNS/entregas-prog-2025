...
public class Leones extends Felinos {
    ...
    public Leones(String sound, String alimentacion, String habitat, String cientName, String nombre, int edad, int peso) {
    ...
    public String toString() {
        return "Leones{ nombre=" + getNombre()+ ", edad=" + getEdad() + ", peso=" + getPeso()+ ", sound=" + sound + ", alimentacion=" + alimentacion + ", habitat=" + habitat + ", cientName=" + cientName + '}';
    }
