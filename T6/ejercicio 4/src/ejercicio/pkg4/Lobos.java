...
public class Lobos extends Canidos {
    ...
    public Lobos(String sound, String alimentacion, String habitat, String cientName, String nombre, int edad, int peso) {
    ...
    public String toString() {
        return "Lobos{ nombre=" + getNombre()+ ", edad=" + getEdad() + ", peso=" + getPeso()+ ", sound=" + sound + ", alimentacion=" + alimentacion + ", habitat=" + habitat + ", cientName=" + cientName + '}';
    }
    //
